...
export function Header() {
  ...
  return (
    <>
      <ShowWhen
        show={
          <div className="block bg-black z-50 opacity-80 fixed w-full h-full" />
        }
        when={showHeader}
      />
        ...
        <div className="max-w-[1300px] w-full flex items-center justify-center">
          ...
          <div
            className={classNames(
              "flex-col gap-4 sm:gap-12 justify-end sm:w-full w-[90%] sm:flex-row sm:relative absolute sm:mt-0 mt-56 sm:flex",
